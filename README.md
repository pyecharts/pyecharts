...
## Instatllation
pyecharts works on Python2 and Python3. The latest release is 0.1.9.4. For more information please refer to [changelog.md](https://github.com/chenjiandongx/pyecharts/blob/master/changelog.md)  
