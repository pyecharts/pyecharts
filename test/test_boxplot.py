...
class TestBoxplotChart(unittest.TestCase):
    ...
    def test_boxplot_base(self, fake_writer):
        ...
        self.assertIn("boxWidth", content)

    @patch("pyecharts.render.engine.write_utf8_html_file")
    def test_boxplot_base_v1(self, fake_writer):
        v1 = [
            [1000, 1000, 1000],
            [200, 200, 200],
        ]
    ...
    @patch("pyecharts.render.engine.write_utf8_html_file")
    def test_boxplot_base_v2(self, fake_writer):
        v1 = [
            None,
            [200, 200, 200],
        ]
    ...
    @patch("pyecharts.render.engine.write_utf8_html_file")
    def test_boxplot_item_base(self, fake_writer):
        x_axis = ["expr1", "expr2"]
        v1 = [
            [850, 740, 900, 1070, 930, 850, 950, 980, 980, 880, 1000, 980],
            [960, 940, 960, 940, 880, 800, 850, 880, 900, 840, 830, 790],
