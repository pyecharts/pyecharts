...
class TestMap3DChart(unittest.TestCase):
    ...
    def test_map3d_base(self, fake_writer):
        c = (
            Map3D()
            .add_schema()
            .add(
    ...
    @patch("pyecharts.render.engine.write_utf8_html_file")
    def test_map3d_schema(self, fake_writer):
        c = (
            Map3D()
            .add_schema(
        ...
        self.assertIn("viewControl", content)
        self.assertIn("postEffect", content)
        self.assertIn("realisticMaterial", content)
        self.assertIn("lambertMaterial", content)
        self.assertIn("colorMaterial", content)

    @patch("pyecharts.render.engine.write_utf8_html_file")
    def test_map3d_with_bar3d(self, fake_writer):
        example_data = [
    ...
    @patch("pyecharts.render.engine.write_utf8_html_file")
    def test_map3d_with_lines3d(self, fake_writer):
        example_data = [
    ...
    @patch("pyecharts.render.engine.write_utf8_html_file")
    def test_map3d_with_line3d(self, fake_writer):
        example_data = [
            [[119.107078, 36.70925, 1000], [116.587245, 35.415393, 1000]],
            [[117.000923, 36.675807], [120.355173, 36.082982]],
            [[118.047648, 36.814939], [118.66471, 37.434564]],
    ...
    @patch("pyecharts.render.engine.write_utf8_html_file")
    def test_map3d_with_scatter3d(self, fake_writer):
        example_data = [
            ("黑龙江", [127.9688, 45.368, 100]),
