...
class DataZoomOpts(BasicOpts):
    def __init__(
        ...
        handle_icon: str = "M8.2,13.6V3.9H6.3v9.7H3.1v14.9h3.3v9.7h1.8v-9.7h3."
        + "3V13.6H8.2z M9.7,24.4H4.8v-1.4h4.9V24.4z M9.7,19.1H4.8v-1.4h4.9V19.1z",
        ...
        pos_bottom: Optional[str] = None,
        disabled: bool = False,
        zoom_on_mousewheel: Union[bool, str] = True,
        move_on_mousemove: Union[bool, str] = True,
        move_on_mousewheel: Union[bool, str] = True,
        prevent_default_mousemove: Union[bool, str] = True,
        xaxis_index: Union[int, Sequence[int], None] = None,
        yaxis_index: Union[int, Sequence[int], None] = None,
        radius_axisindex: Union[int, Sequence[int], None] = None,
        angle_axisindex: Union[int, Sequence[int], None] = None,
        filter_mode: str = "filter",
        range_start: Numeric = 0,
        range_end: Numeric = 100,
        start_value: Union[int, str, None] = None,
        end_value: Union[int, str, None] = None,
        min_span: Union[Numeric, None] = None,
        max_span: Union[Numeric, None] = None,
        min_valuespan: Union[Numeric, str, None] = None,
        max_valuespan: Union[Numeric, str, None] = None,
        orient: str = "horizontal",
        ...
        if type_ == "slider":
            self.opts: dict = {
                ...
                "DataBackgroundOpts": databackground_opts,
                "fillerColor": filler_color,
                "borderColor": border_color,
                "borderWidth": border_width,
                "handleIcon": handle_icon,
                "handleSize": handle_size,
                "handleStyle": handlestyle_opt,
                "labelPrecision": label_precision,
                "labelFormatter": label_formatter,
                "showDetail": show_detail,
                "showDataShadow": show_datashadow,
                "realtime": is_realtime,
                "textStyle": text_style,
                "xAxisIndex": xaxis_index,
                "yAxisIndex": yaxis_index,
                "radiusAxisIndex": radius_axisindex,
                "angleAxisIndex": angle_axisindex,
                ...
                "minSpan": min_span,
                "maxSpan": max_span,
                "minValueSpan": min_valuespan,
                "maxValueSpan": max_valuespan,
                "orient": orient,
            ...
            self.opts: dict = {
                ...
                "throttle": throttle,
                "rangeMode": range_mode,
                "zoomOnMouseWheel": zoom_on_mousewheel,
                "moveOnMouseMove": move_on_mousemove,
                "moveOnMouseWheel": move_on_mousewheel,
    ...
    def inside(
        ...
        return cls(
            ...
            radius_axisindex=radius_axisindex,
            angle_axisindex=angle_axisindex,
            ...
            min_span=min_span,
            max_span=max_span,
            min_valuespan=min_valuespan,
            max_valuespan=max_valuespan,
            orient=orient,
            is_zoom_lock=is_zoom_lock,
            throttle=throttle,
            range_mode=range_mode,
            zoom_on_mousewheel=zoom_on_mousewheel,
            move_on_mousemove=move_on_mousemove,
            move_on_mousewheel=move_on_mousewheel,
            prevent_default_mousemove=prevent_default_mousemove,
            args=args,
        )
    ...
    def slider(
        ...
        return cls(
            ...
            databackground_opts=databackground_opts,
            filler_color=filler_color,
            border_color=border_color,
            handle_icon=handle_icon,
            handle_size=handle_size,
            handlestyle_opt=handlestyle_opt,
            label_precision=label_precision,
            label_formatter=label_formatter,
            show_detail=show_detail,
            show_datashadow=show_datashadow,
