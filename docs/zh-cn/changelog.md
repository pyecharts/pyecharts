...
* ### version 0.6.0（dev）
    ...
    * [issue#669](https://github.com/pyecharts/pyecharts/issues/669) 新增树图，Tree。
...
* ### version 0.5.7 - 2018.8.11（current）
    ...
    * [pr#663](https://github.com/pyecharts/pyecharts/pull/663) 新增 `coordinate_region` 参数并且新增 echarts-cities-pypkg 为可选的地理数据扩展。引入来自 [geonames.org](http://geonames.org/) 的 138,398 个城市坐标。
